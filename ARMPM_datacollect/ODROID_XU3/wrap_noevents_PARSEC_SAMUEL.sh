...
#All Cores HighA15freq
./MC_XU3.sh -b 4 -L 4 -f 1800000,1700000,1600000,1500000,1400000,1300000,1200000,1100000 -q 1400000 -n 2 -x /home/Work/DATACOLLECT/ARMPM_datacollect/Workloads/parsec-3.0/parsec_benchlist_timestamp_cset.sh -t 500000000 -s /home/Work/DATACOLLECT/Results/XU3_1/cset_perfcpu_PARSEC_green_eMMC_c8_bighighfreq/noevents/
