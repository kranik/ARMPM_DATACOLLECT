...
The benchmarks I used in my experiments are also given in [`bench_list.data`](BenchmarkMods/parsec-3.0/bench_list.data). Again you can also comment out unwanted benchmarks from the list.
